export const Basket = (props) => {
  return (
    <svg width="24" height="20" viewBox="0 0 24 20" fill="none" {...props}
      ...
      <defs>
        <linearGradient id="basket-gradient" gradientUnits="userSpaceOnUse" fy="90%">
          <stop offset="0" style={{ stopColor: '#EBFF00' }} />
          <stop offset="1" style={{ stopColor: '#FF70D9'}} />
        </linearGradient>
        <mask id="icon-mask" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="20">
          <path fillRule="evenodd" clipRule="evennod"
      ...
      <g mask="url(#icon-mask)">
        <rect x="0" y="0" width="24" height="20" fill="currentColor" />
        <rect className="icon-gradient" x="0" y="0" width="24" height="20" fill="url(#basket-gradient)" />
      </g>
    </svg>
  )
}
